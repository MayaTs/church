...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var choices_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! choices.js */ \"./node_modules/choices.js/public/assets/scripts/choices.js\");\n/*let select = function () {\r\n    let selectHeader = document.querySelectorAll('.select__header');\r\n    let selectItem = document.querySelectorAll('.select__item');\r\n\r\n    selectHeader.forEach(item => {\r\n        item.addEventListener('click', selectToggle)\r\n            //document.querySelector('.select').classList.toggle('is-active');\r\n\r\n        //})\r\n    });\r\n\r\n    selectItem.forEach(item => {\r\n        item.addEventListener('click',  selectChoose)\r\n\r\n        \r\n    });\r\n\r\n    function selectToggle() {\r\n        this.parentElement.classList.toggle('is-active');\r\n    }\r\n\r\n    function selectChoose() {\r\n        let text = this.innerText,\r\n        select = this.closest('.select'),\r\n        currentText = select.querySelector('.select__current');\r\n        currentText.innerText = text;\r\n        select.classList.remove('.is-active');\r\n\r\n    }\r\n    console.log('no');\r\n};\r\n\r\nselect();*/\r\n\r\n\r\n\r\nconst defaultSelect = () => {\r\n    const elements = document.querySelectorAll('.transfer-order__input_city');\r\n    elements.forEach(el => {\r\n        const choices = new choices_js__WEBPACK_IMPORTED_MODULE_0__(el, {\r\n            searchEnabled: true,\r\n        });\r\n    });\r\n    \r\n}\r\ndefaultSelect();\r\n\r\nconsole.log(\"select\");\r\n\r\n\r\n/*--------------------------------экскурсии---------------------------------------*/\r\ndocument.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"vitebsk\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"mogilev\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"grodno\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"gomel\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"minsk\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"brest\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n    document.getElementById('order_from_place-g1_business').addEventListener('change', function(){\r\n        let isPear = this.options[this.selectedIndex].classList.contains(\"foreign\");\r\n        document.getElementById('cars-order__vehicle_price').innerHTML = (1*20) + \" BYN\";\r\n        document.getElementById('cars-order__vehicle_price-top').innerHTML = \"от \" + 600 + \" BYN\";\r\n   \r\n    });\r\n\r\n\r\n  /*----------------------------------------------------------------------------------------*/\r\nwindow.onload = function() {       \r\n    checkbox__input.addEventListener(\"click\", myFoo1);\r\n    function myFoo1()\r\n    {\r\n      const COEFF = 2;\r\n      let items = document.getElementsByClassName('cars-order__vehicle_price');\r\n        if (checkbox__input.checked) \r\n        { \r\n         \r\n          for (let i = 0; i < items.length; i++) {\r\n      let item = items[i];\r\n      item.innerText = parseInt(item.innerText, 10) * COEFF  +' BYN';\r\n      \r\n  }; \r\n  console.log(items);\r\n        } \r\n        else \r\n        {   \r\n          \r\n            for (let i = 0; i < items.length; i++) {\r\n                let item = items[i];\r\n                item.innerText = parseInt(item.innerText, 10) / COEFF  +' BYN';\r\n            }; \r\n        }\r\n    }       \r\n  };\r\n\n\n//# sourceURL=webpack://maya/./src/js/modules/select.js?");
